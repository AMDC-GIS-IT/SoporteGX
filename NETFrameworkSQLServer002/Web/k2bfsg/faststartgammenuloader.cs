...
namespace GeneXus.Programs.k2bfsg {
   public class faststartgammenuloader : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         /* Execute user subroutine: 'CHECKSECURITYFORWWSOPORTE' */
         S251 ();
         if ( returnInSub )
         {
            this.cleanup();
         ...
         GXt_boolean5 = true;
         new k2bmenuaddprogram(context ).execute(  "WWsoporte",  context.GetMessage( "SOPORTE", ""),  "",  "",  formatLink("wwsoporte.aspx") ,  14,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean5, ref  AV10MenuLevel0) ;
         this.cleanup();
      }
      ...
      protected void S251( )
      {
         /* 'CHECKSECURITYFORWWSOPORTE' Routine */
         returnInSub = false;
         AV9ActivityItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV9ActivityItem.gxTpr_Activity.gxTpr_Entityname = "soporte";
         AV9ActivityItem.gxTpr_Activity.gxTpr_Transactionname = "soporte";
         AV9ActivityItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV9ActivityItem.gxTpr_Activity.gxTpr_Pgmname = "WWsoporte";
         AV8ActivityList.Add(AV9ActivityItem, 0);
      }
